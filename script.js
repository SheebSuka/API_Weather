document.addEventListener('DOMContentLoaded', () => {
    ...
    let temperaturasPorDefecto = [];
    const ciudadesPorDefectoOriginal = ['Nogales', 'Arizona', 'Japan', 'Lima', 'Santiago'];
    ...
    document.getElementById('agregarCiudadBtn').addEventListener('click', () => {
        ...
        if (!ciudadesPorDefecto.includes(nuevaCiudad) && !ciudadesBuscadas.some(c => c.nombre === nuevaCiudad)) {
            ciudadesPorDefecto.push(nuevaCiudad);
            guardarCiudadesPorDefecto();
            fetchDatosClima(nuevaCiudad, false, true);
            document.getElementById('nuevaCiudadInput').value = "";
        } else {
